...
DEPT_SEARCHABLE_FIELDS = [
    {"name": "id", "display_name": "部门ID", "type": "string"},
    {"name": "name", "display_name": "部门名称", "type": "string"},
    {"name": "code", "display_name": "部门编码", "type": "string"},
    {"name": "dept_type", "display_name": "部门类型", "type": "string"},
    {"name": "status", "display_name": "状态", "type": "boolean"},
    {"name": "parent_id", "display_name": "父部门ID", "type": "string"},
    {"name": "level", "display_name": "层级", "type": "integer"},
    {"name": "sys_create_datetime", "display_name": "创建时间", "type": "datetime"},
]


class DeptQueryIn(Schema):
    """部门动态查询请求"""
