...
class PermissionSchemaIn(ModelSchema):
    """权限输入模式"""
    menu_id: str = Field(..., alias="menu_id", description="菜单ID（关联 Menu 模型/表 core_menu.id）")
...
class PermissionSchemaPatch(Schema):
    ...
    menu_id: Optional[str] = Field(None, description="菜单ID（关联 Menu 模型/表 core_menu.id）")
...
class PermissionSchemaOut(ModelSchema):
    """权限输出模式"""
    menu_id: Optional[str] = Field(None, alias="menu_id", description="菜单ID（关联 Menu 模型/表 core_menu.id）")
