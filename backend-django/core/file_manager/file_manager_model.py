...
class FileManager(RootModel):
    ...
    parent = models.ForeignKey('self', on_delete=models.CASCADE, null=True, blank=True, related_name='children', help_text="父文件夹，自引用 FileManager 模型/表 core_file_manager.id")
