...
class FileManagerFilters(FuFilters):
    ...
    parent_id: UUID4 = Field(None, alias="parent_id", description="父文件夹ID（自引用 FileManager 模型/表 core_file_manager.id）")
...
class FileManagerSchemaIn(ModelSchema):
    """文件管理输入Schema"""
    parent_id: UUID4 | None = Field(None, alias="parent_id", description="父文件夹ID（自引用 FileManager 模型/表 core_file_manager.id）")
...
class FileManagerSchemaOut(ModelSchema):
    """文件管理输出Schema"""
    parent_id: UUID4 | None = Field(None, description="父文件夹ID（自引用 FileManager 模型/表 core_file_manager.id）")
    id: UUID4 = Field(...)
